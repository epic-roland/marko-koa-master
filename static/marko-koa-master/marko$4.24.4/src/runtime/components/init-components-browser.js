$_mod.def("/marko$4.24.4/src/runtime/components/init-components-browser", function(require, exports, module, __filename, __dirname) { "use strict";
var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
var warp10Finalize = require('/warp10$2.0.2/finalize'/*"warp10/finalize"*/);
var eventDelegation = require('/marko$4.24.4/src/runtime/components/event-delegation'/*"./event-delegation"*/);
var win = window;
var defaultDocument = document;
var createFragmentNode = require('/marko$4.24.4/src/runtime/vdom/morphdom/fragment'/*"../vdom/morphdom/fragment"*/)
  .___createFragmentNode;
var componentsUtil = require('/marko$4.24.4/src/runtime/components/util-browser'/*"./util-browser"*/);
var componentLookup = componentsUtil.___componentLookup;
var addComponentRootToKeyedElements =
  componentsUtil.___addComponentRootToKeyedElements;
var ComponentDef = require('/marko$4.24.4/src/runtime/components/ComponentDef'/*"./ComponentDef"*/);
var registry = require('/marko$4.24.4/src/runtime/components/registry-browser'/*"./registry"*/);
