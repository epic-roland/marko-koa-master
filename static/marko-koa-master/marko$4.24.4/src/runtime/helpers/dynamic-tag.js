$_mod.def("/marko$4.24.4/src/runtime/helpers/dynamic-tag", function(require, exports, module, __filename, __dirname) { "use strict";

var complain = "MARKO_DEBUG" && require('/complain$1.6.0/index'/*"complain"*/);
var changeCase = require('/marko$4.24.4/src/runtime/helpers/_change-case'/*"./_change-case"*/);
var ComponentsContext = require('/marko$4.24.4/src/runtime/components/ComponentsContext'/*"../components/ComponentsContext"*/);
var getComponentsContext = ComponentsContext.___getComponentsContext;
var ComponentDef = require('/marko$4.24.4/src/runtime/components/ComponentDef'/*"../components/ComponentDef"*/);
var w10NOOP = require('/warp10$2.0.2/constants'/*"warp10/constants"*/).NOOP;
